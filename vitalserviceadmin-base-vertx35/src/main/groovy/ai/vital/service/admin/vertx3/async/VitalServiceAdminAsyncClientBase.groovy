 ...
 *
 */
abstract class VitalServiceAdminAsyncClientBase {

	Vertx vertx
	
	VitalServiceAdminAsyncClientBase(Vertx vertx) {
		if(vertx == null) throw new NullPointerException("Null Vertx instance")
		this.vertx = vertx
	}
	
	protected abstract void impl(Closure closure, String method, List args)
