...
import ai.vital.service.vertx3.AbstractVitalServiceVertxTest;
...
class VitalServiceVertxTest extends AbstractVitalServiceVertxTest {
	...
	public void testStreamHandlers() {
		...
		*/
		...
		ltp.vertx.eventBus().consumer('stream.' + session1) { Message msg ->
		...
		ltp.vertx.eventBus().consumer('stream.' + session2) { Message msg ->
		...
		ltp.vertx.eventBus().consumer('stream.' + session3) { Message msg ->
